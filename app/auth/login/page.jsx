...
export default function LoginPage() {
  ...
  const handleLogin = () => {
    ...
    if (user && formData.password === "demo123") {
      ...
      setErrors({
        email: "Invalid credentials. Try: player@demo.com, agent@demo.com, or admin@demo.com with password: demo123",
      })
    }
  }
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <AnimatedButton variant="primary" size="lg" className="w-full" onClick={handleLogin}>
          Log In
        </AnimatedButton>
