  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#0A1A2F] to-black/50 text-white relative overflow-hidden">
      ...
      <main className="relative container mx-auto px-4 py-36 grid grid-cols-12 gap-6">
        ...
        <section className="col-span-8 space-y-4">
          <div className="rounded-md overflow-hidden border border-black/30 bg-gradient-to-b from-black/40 to-black/30 shadow-lg">
            <div className="px-4 py-3 flex items-center justify-between border-b border-black/20">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-300">
                ...
                <button className="px-2 py-1 rounded bg-black/20">
                  Filter
                </button>
              </div>
            </div>

            <div className="divide-y bg-gradient-to-b from-[#0A1A2]/80 to-[#FFD700]/80 backdrop-blur-sm border border-[#0A1A2F]/60">
              {matches.map((m) => (
                <div
                  key={m.id}
                  className="px-4 py-3 hover:bg-black/20 transition flex items-start gap-4"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 grid grid-cols-12 items-center gap-4">
                      <div className="col-span-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-b from-[#0A1A2]/80 to-[#FFD700]/80 backdrop-blur-sm border border-[#0A1A2F]/60 flex items-center justify-center text-xs font-bold">
                              T
                            </div>
                            <div>
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-b to-[#0A1A2F]/80 from-[#FFD70]/80 backdrop-blur-sm border border-[#0A1A2F]/60 flex items-center justify-center text-xs font-bold">
                              U
                            </div>
                            <div>
                              <div className="text-sm font-semibold">
                      ...
                      <div className="col-span-6 flex items-center justify-end gap-4">
                        ...
                        <div className="flex gap-2">
                          {m.odds.map((o, idx) => (
                            <div
                              key={idx}
                              className="px-3 py-2 rounded shadow-inner bg-black/40 border border-black/30 text-sm font-semibold hover:scale-105 transform transition"
                            >
                              {o}
                            </div>
                          ))}
                        ...
                        <div className="w-8 h-8 rounded-md bg-black/30 flex items-center justify-center text-sm">
                          ▶
                        </div>
                      </div>
                    </div>
          ...
          <div className="flex justify-center">
            <button className="px-4 py-2 rounded-md bg-[#2b0f08] hover:bg-[#3a1308] transition">
              Load more
            </button>
          </div>
        </section>
        ...
        <aside className="fixed right-20 top-32 max-w-3xl mx-auto py-6 px-4 space-y-6">
          ...
          <div className=" rounded-md border border-orange-400/90 shadow-lg p-4">
            ...
            <div className="flex gap-6 text-sm mt-4 border-b border-black/40">
              {["Stats", "Player Stats", "Timeline", "Lineups", "Table"].map(
                (t, idx) => (
                  <button
                    key={idx}
                    className={`py-2 ${
            ...
            <div className="mt-4 space-y-6">
              ...
              <div className="grid grid-cols-3 text-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-center gap-2 font-semibold">
                    ...
                    <span className="text-blue-400">49</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 text-center text-sm bg-[#0f0f0f] rounded overflow-hidden">
                  ...
                  <div className="py-4 border-r border-black/40 bg-black/40">
                    57.2%
                  </div>
      ...
      <footer className="max-w-[1400px] mx-auto px-4 pb-8 text-center text-gray-500 text-xs">
        <div className="mt-4">
          Animated demo UI — colors tuned to a dark reddish-orange theme. Built
          with Tailwind.
        </div>
      </footer>
    </div>
